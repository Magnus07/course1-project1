...
//int cmpStore(void *p, string key){
...
//int cmpProduct(void *p, string key){
...
//void FindElList(void** start,  string key, int &posFndEl, bool &findOK, TfuncCmp pFunc)
//{
